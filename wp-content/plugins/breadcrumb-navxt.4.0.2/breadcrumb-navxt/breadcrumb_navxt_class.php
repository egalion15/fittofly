...
class bcn_breadcrumb
{
	...
	public function bcn_breadcrumb($title = '', $template = '', $type = '', $url = NULL)
	{
		...
		if($template == NULL)
		{
			$template = __('<a title="Перейти %title%." href="%link%">%htitle%</a>', 'breadcrumb_navxt');
		}
		if($url == NULL)
		{
...
class bcn_breadcrumb_trail
{
	...
	function bcn_breadcrumb_trail()
	{
		...
		$this->opt = array(
			...
			'Smainsite_title' => __('Главная', 'breadcrumb_navxt'),
			//The breadcrumb template for the main site, this is global, four keywords are available %link%, %title%, %htitle%, and %type%
			'Hmainsite_template' => __('<a title="Перейти %title%." href="%link%">%htitle%</a>', 'breadcrumb_navxt'),
			...
			'Shome_title' => __('Главная', 'breadcrumb_navxt'),
			//The breadcrumb template for the home page, this is global, four keywords are available %link%, %title%, %htitle%, and %type%
			'Hhome_template' => __('<a title="Перейти %title%." href="%link%">%htitle%</a>', 'breadcrumb_navxt'),
			...
			'Hblog_template' => __('<a title="Перейти %title%." href="%link%">%htitle%</a>', 'breadcrumb_navxt'),
			...
			'Hpost_page_template' => __('<a title="Перейти %title%." href="%link%">%htitle%</a>', 'breadcrumb_navxt'),
			...
			'Hpaged_template' => __('Страница %htitle%', 'breadcrumb_navxt'),
			...
			'Hpost_post_template' => __('<a title="Перейти %title%." href="%link%">%htitle%</a>', 'breadcrumb_navxt'),
			...
			'Hpost_attachment_template' => __('<a title="Перейти %title%." href="%link%">%htitle%</a>', 'breadcrumb_navxt'),
			...
			'Hsearch_template' => __('Результаты поиска &#39;<a title="Перейти на первую страницу результатов поиска %title%." href="%link%">%htitle%</a>&#39;', 'breadcrumb_navxt'),
			...
			'Hsearch_template_no_anchor' => __('Результаты поиска &#39;%htitle%&#39;', 'breadcrumb_navxt'),
			//Tag related stuff
			//The breadcrumb template for tag breadcrumbs, four keywords are available %link%, %title%, %htitle%, and %type%
			'Hpost_tag_template' => __('<a title="Перейти %title% тег архива." href="%link%">%htitle%</a>', 'breadcrumb_navxt'),
			...
			'Hauthor_template' => __('Статьи: <a title="Перейти на первую страницу поста %title%." href="%link%">%htitle%</a>', 'breadcrumb_navxt'),
			...
			'Hauthor_template_no_anchor' => __('Статьи: %htitle%', 'breadcrumb_navxt'),
			...
			'Hcategory_template' => __('<a title="Перейти в %title% категорию архива." href="%link%">%htitle%</a>', 'breadcrumb_navxt'),
			...
			'Hdate_template' => __('<a title="Перейти the %title% archives." href="%link%">%htitle%</a>', 'breadcrumb_navxt'),
