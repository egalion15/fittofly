  ...
  <?php wp_head(); ?>
	...
	<div id="wrap" class="fix">	
		...
		<div id="menu"><div id="mleft"></div>
			...
			<ul id="nav"><li id="show" ><a href="<?php bloginfo('home'); ?>/poisk-klubov">Поиск клубов</a></li><div class="dec"></div><li><a href="<?php bloginfo('home'); ?>/magazin">Каталог товаров</a></li><div class="dec"></div><li><a href="<?php bloginfo('home'); ?>/dnevniki-jukari">Дневники</a></li><div class="dec"></div><li><a href="<?php bloginfo('home'); ?>/chasto-zadavaemye-voprosy">Часто задаваемые вопросы</a></li><div class="dec"></div><div class="dec"></div><li><a href="#">Свежие обсуждения</a></li>
		...
		<div id="dwrap">
		<? $numpost=4; if($paged>1) $offset=$numpost*($paged-1); else $offset=0; query_posts('cat=25&offset='.$offset.'&showposts='.$numpost); ?>
