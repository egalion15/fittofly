  ...
  <?php wp_head(); ?>
	...
	<div id="wrap" class="fix">	
		...
		<div id="menu"><div id="mleft"></div>
			...
			<ul id="nav"><li id="show" ><a href="<?php bloginfo('home'); ?>/poisk-klubov">Поиск клубов</a></li><div class="dec"></div><li><a href="<?php bloginfo('home'); ?>/category/tovary">Каталог товаров</a></li><div class="dec"></div><li><a href="<?php bloginfo('home'); ?>/dnevniki-jukari">Дневники</a></li><div class="dec"></div><li><a href="<?php bloginfo('home'); ?>/chasto-zadavaemye-voprosy">Часто задаваемые вопросы</a></li><div class="dec"></div><li><a href="#">Свежие обсуждения</a></li>
...
endwhile;
         ...
         { ?>
			<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
				...
				<div class="text fix"><? the_content();?></div></div>
