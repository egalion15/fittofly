...
<body class="login">
<?php   if ( !is_multisite() ) { ?>
<div id="login"><h1><a href="<?php echo esc_url( apply_filters('login_headerurl','fittofly.com.ua') ); ?>" title="<?php echo esc_attr( apply_filters('login_headertitle', __( 'Сделано в веб-студии Тадатута' ) ) ); ?>"><?php bloginfo('name'); ?></a></h1>
<?php   } else { ?>
